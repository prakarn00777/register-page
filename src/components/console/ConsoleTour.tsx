...
export default function ConsoleTour({ onForceOpenSidebar, onCloseSidebar }: ConsoleTourProps) {
    ...
    const steps: Step[] = [
        ...
        {
            target: '[data-tour="tour-nav-import"]',
            content: "นำเข้าข้อมูลลูกค้าหรือรายการต่างๆ เข้าสู่ระบบได้ที่นี่",
            title: "นำเข้าข้อมูล",
            placement: "right",
            disableBeacon: true,
        },
        ...
        {
            target: '[data-tour="tour-settings-group"]',
            content: `แก้ไขข้อมูล${entity} จัดการสาขา และดูข้อมูลบัญชีได้ที่นี่`,
            title: "ตั้งค่า",
            placement: "right",
            disableBeacon: true,
        },
